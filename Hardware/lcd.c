...
//	uint16_t HZnum;//汉字数目
	...
	uint16_t HZnum = sizeof(tfont12) / sizeof(typFNT_GB12);  // 统计 UTF-8 汉字数目	
...
//	HZnum=sizeof(tfont16)/sizeof(typFNT_GB16);	//统计汉字数目
	uint16_t HZnum = sizeof(tfont16) / sizeof(typFNT_GB16);  // 统计 UTF-8 汉字数目
	for(k=0;k<HZnum;k++) 
	{
...
/******************************************************************************
      ...
      返回值：  无
******************************************************************************/
void LCD_ShowFloatNum4(uint16_t x,uint16_t y,float num,uint8_t len,uint16_t fc,uint16_t bc,uint8_t sizey)
{         	
	uint8_t t,temp,sizex;
	uint16_t num1;
	sizex=sizey/2;
...
/******************************************************************************
      ...
      返回值：  无
******************************************************************************/
void LCD_ShowFloatNum5(uint16_t x,uint16_t y,float num,uint8_t len,uint16_t fc,uint16_t bc,uint8_t sizey)
{         	
	uint8_t t,temp,sizex;
	uint16_t num1;
	sizex=sizey/2;
