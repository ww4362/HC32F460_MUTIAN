...
SW6306_RET SW6306_Reset(SW6306_NOARG)
{
	SW6306_SPAWN_ARGS(SW6306_RegsetSwitch, SW6306_CTRG_CLICK);
	  SW6306_SPAWN_ARGS(SW6306_ByteWrite, SW6306_CTRG_RESET	, 0x20);
    SW6306_SPAWN_ARGS(SW6306_ByteWrite, SW6306_CTRG_RESET	, 0x40);
    SW6306_SPAWN_ARGS(SW6306_ByteWrite, SW6306_CTRG_RESET	, 0x80);
}
...
//		
    ...
    SW6306_SPAWN_ARGS(SW6306_RegsetSwitch, SW6306_CTRG_DCHG4);
	 ...
	 //4.2 v电池  修改电池需要更改的参数
    SW6306_SPAWN_ARGS(SW6306_ByteWrite, SW6306_CTRG_CHG1, SW6306_CHG1_BTYPE_REGSET|SW6306_CHG1_BTYPE_4V2|SW6306_CHG1_SERIES_REGSET|SW6306_CHG1_5S);
    ...
    SW6306_SPAWN_ARGS(SW6306_ByteModify, SW6306_CTRG_DCDC1, SW6306_DCDC1_MSK, SW6306_DCDC1_2R5);
		//插入拔出检测配置4 禁止无线充模式 禁止小电流模式
		    SW6306_SPAWN_ARGS(SW6306_ByteWrite, SW6306_CTRG_INDET4, SW6306_INDET4_WLSSREGSET|SW6306_INDET4_BLUTHREGSET);
		
	
	//    //端口快充全部使能
    SW6306_SPAWN_ARGS(SW6306_ByteModify, SW6306_CTRG_PORTQC, SW6306_PORTQC_MSK, 0x33);
    //输入快充申请的电压跟随根据电池电压设置优先级，输入快充最高申请15V电压  这个寄存器默认即可
   // SW6306_SPAWN_ARGS(SW6306_ByteModify, SW6306_CTRG_VCHG, SW6306_VCHG_MSK, SW6306_VCHG_BATT_VRSQ|SW6306_VCHG_MVRSQ_20V);
    //高压快充协议功率跟随系统设置
