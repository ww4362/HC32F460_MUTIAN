...
/*****************************函数声明区***************************************/
//I2C函数
SW6306_RET SW6306_ByteWrite(SW6306_ARGS(uint16_t reg, uint8_t data));  //写
SW6306_RET SW6306_ByteRead(SW6306_ARGS(uint16_t reg, volatile uint8_t *data)); //读一个字节
SW6306_RET SW6306_BytesRead(SW6306_ARGS(uint16_t reg, uint8_t *pdata, uint16_t len)); //读多个字节
SW6306_RET SW6306_RegsetSwitch(SW6306_ARGS(uint16_t regset));//寄存器切换
//ADC数据相关操作
